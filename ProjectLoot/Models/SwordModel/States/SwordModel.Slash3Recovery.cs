...
public class Slash3Recovery : ParentedTimedState<SwordModel>
{
    ...
    public override IState? EvaluateExitConditions()
    {
        ...
        if (TimeInState > TimeSpan.Zero && Parent.MeleeWeaponComponent.MeleeWeaponInputDevice.HeavyAttack.IsDown)
        {

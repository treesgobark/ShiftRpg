...
public class ShatterDamageHandler : IEffectHandler<ShatterDamageEffect>
{
    ...
    {
        if (effect is ShatterDamageEffect damageEffect)
        {
            Handle(damageEffect);
        }
        else
    ...
    public void Handle(ShatterDamageEffect effect)
    {
